...
function PageWidgeTab() {
  return (
    <>
      ...
      <h3 className="section-header">Clipboard Widget</h3>
      <div className="columns is-multiline no-subs-section">
        <div className="column is-12 vertical-center">
          <label className="checkbox">
            <input
              type="checkbox"
              name="pageWidgetContext"
              disabled
              defaultChecked
            />
            Show "Run Clipboard Widget" in the context menu
          </label>
        </div>
        <div className="column is-8">
          <button className="button is-outlined" disabled>
            <span className="icon">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="far"
                data-icon="keyboard"
                className="svg-inline--fa fa-keyboard fa-w-18 "
                role="img"
            ...
            <span>Configure widget run shortcut</span>
          </button>
        </div>
        <div className="column is-12 vertical-center">
          <a
            href="https://clipboardextension.com/pro.html?utm_campaign=options&utm_medium=extension&utm_source=widget_tab#clipboard-widget-feature"
            className="external-link"
            target="_blank"
            rel="noopener noreferrer"
          >
            &gt; Read more about Clipboard Widget
          </a>
        </div>
      </div>
    </>
